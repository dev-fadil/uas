...
class Produk(models.Model):
    ...
    keterangan_barang = RichTextField(blank=True, null=True)
...
class Slide(models.Model):
    ...
    gambar_slide = ResizedImageField(size=[880, 475], quality=80, crop=['middle', 'center'] , upload_to='gambar/banner', blank=True, null=True, verbose_name="Gambar (475 x 880 pixel)")
    aktif = models.BooleanField(default=True)
